...
class __TwigTemplate_bd11a0b60450302427dbaf37d931e29ea7c6044f54961747515e84db646d41fe extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["block" => 1, "set" => 2];
        $filters = ["escape" => 3, "t" => 3, "default" => 18];
        $functions = ["url" => 3];
...
";
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 3
        echo "    <a href=\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("webprofiler.dashboard", ["profile" => ($context["token"] ?? null)], ["fragment" => "views"]), "html", null, true);
        echo "\" title=\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Views"));
        echo "\">
        ...
        // line 6
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["collector"] ?? null), "getViewsCount", [])), "html", null, true);
        echo "</span>
    </a>
    ";
...
";
    ...
    public function block_panel($context, array $blocks = [])
    {
        ...
        echo "</th>
                    <th>";
        // line 32
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("display"));
        echo "</th>
                    <th>";
        // line 33
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("build time"));
        echo "</th>
                    <th>";
        // line 34
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("execute time"));
        echo "</th>
                    <th>";
        // line 35
        ...
        echo "</th>
                    <th>";
        // line 36
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Action"));
        echo "</th>
                </tr>
                </thead>
                <tbody>
...
";
    ...
    {
        return array (  198 => 53,  189 => 47,  175 => 36,  171 => 35,  167 => 34,  163 => 33,  159 => 32,  155 => 31,  146 => 25,  143 => 24,  137 => 23,  127 => 19,  123 => 18,  119 => 16,  113 => 13,  109 => 12,  105 => 10,  102 => 9,  96 => 6,  92 => 5,  88 => 4,  81 => 3,  78 => 2,  72 => 1,  65 => 23,  62 => 22,  60 => 1,);
    }
    ...
    {
        return new Source("", "@webprofiler/Collector/views.html.twig", "C:\\Users\\wageeh\\Sites\\devdesktop\\Mod_frontend\\modules\\devel\\webprofiler\\templates\\Collector\\views.html.twig");
    }
}
